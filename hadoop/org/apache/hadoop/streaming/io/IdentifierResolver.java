...
public class IdentifierResolver {
  ...
  // TODO Adding Shm
  public static final String SHM_ID = "shm"; 
  ...
  public void resolve(String identifier) {
    ...
    } else if (identifier.equalsIgnoreCase(SHM_ID)){ // TODO To add shm
     	setInputWriterClass(ShmInputWriter.class);
        setOutputReaderClass(ShmOutputReader.class);
