...
public class TextInputWriter extends InputWriter<Object, Object> {
  ...
  public void initialize(PipeMapRed pipeMapRed) throws IOException {
	//Debug.writeTime();
    //Debug.writeDebug("In TextInputWriter::initialize!\n");
  ...
  private void writeUTF8(Object object) throws IOException {
	//Debug.writeTime();
	//Debug.writeDebug("In TextInputWriter::write!\n");
    byte[] bval;
    int valSize;
    ...
    //Debug.writeDebug("The data of " + valSize + " bytes being writen is: \n");
	//Debug.writeDebug(new String(bval, 0, valSize) + "\n");
