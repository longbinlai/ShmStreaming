...
hadoop jar /home/epcc/robeen/hadoop-0.21.0-streaming.jar \
  ...
  -jobconf stream.shm.map.input.unlock.full.semaphore=200 \
  -jobconf stream.shm.map.output.unlock.empty.semaphore=200 \ 
  -jobconf stream.shm.map.output.unlock.full.semaphore=200  
